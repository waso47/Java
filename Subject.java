...
public class Subject implements Cloneable
{
    ...
    public void enrollerStudentRemove(CourseWorkStudent courseWorkStudent)
    {
        if(enrolledStudent.contains(courseWorkStudent))
        {
            enrolledStudent.remove(courseWorkStudent);
        }
    }
    ...
    public Subject clone() throws CloneNotSupportedException
    {
        ...
        subject.enrolledStudent = new ArrayList<CourseWorkStudent>(0);
        return  subject;
    }
