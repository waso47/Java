...
public class SMSFrame extends JFrame
{
    ...
    private final GridLayout smsFrame;
    ...
    public static void main(String args[])
    {
        ...
        smsFrame.setSize(300, 200);
        smsFrame.setVisible(true);
        smsFrame.jButton1 = new JButton();
    }
    ...
    public class SchoolManagementSystem implements Cloneable
{
    ...
    public void main1() throws CloneNotSupportedException, NoInputException
    {
    ...
    public int intInput()//Error checking for integers
    {
        boolean input = false;
        int choice = 0;
        Scanner scan = new Scanner(System.in);
    ...
    public String noInput(String input) throws NoInputException
    {
        Scanner scan = new Scanner(System.in);
        try
        {
