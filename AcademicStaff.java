...
public class AcademicStaff extends Staff
{
    ...
    public void teachingSubjectsRemove(String code)
    {
    ...
    public void HDRStudentSupervisionRemove(String identifier)
    {
        for(HDRStudent hdrStudent:HDRStudentSupervision)
        {
            if(hdrStudent.getID().equals(identifier))
            {
                HDRStudentSupervision.remove(hdrStudent);
                break;
            }
        }
    }
